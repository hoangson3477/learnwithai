...
const providers = [
  {
    ...
    bgColor: 'bg-white border border-slate-300 hover:bg-slate-50',
  ...
  const handleSocialLogin = async (providerId: string) => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: providerId as 'google' | 'discord' | 'facebook',
        options: {
      ...
      <div className="grid grid-cols-3 gap-3">
        {providers.map((provider) => (
          <button
            ...
            className={`flex items-center justify-center gap-2 py-2.5 rounded-xl font-medium transition-all duration-200 ${provider.bgColor} ${provider.textColor} ${
